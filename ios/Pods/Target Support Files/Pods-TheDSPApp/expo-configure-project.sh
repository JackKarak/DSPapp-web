...
with_node \
  ...
  --target "/Users/alyssamanchester/Documents/DSPapp/ios/Pods/Target Support Files/Pods-TheDSPApp/ExpoModulesProvider.swift" \
  --entitlement "/Users/alyssamanchester/Documents/DSPapp/ios/TheDSPApp/TheDSPApp.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-blur" "expo-constants" "expo-document-picker" "expo-file-system" "expo-font" "expo-haptics" "expo-image" "expo-keep-awake" "expo-linking" "expo-router" "expo-splash-screen" "expo-symbols" "expo-system-ui" "expo-web-browser"
