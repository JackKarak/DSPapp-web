-- =====================================================
-- COMPLETE SQL MIGRATION FOR DYNAMIC POINT CATEGORIES
-- Run this entire file in Supabase SQL Editor
-- =====================================================

-- =====================================================
-- PART 1: Point Categories Table and Functions
-- =====================================================

-- Create the point_categories table
...
-- =====================================================
-- PART 2: Update Point Thresholds Function (RLS Fix)
-- =====================================================

CREATE OR REPLACE FUNCTION update_point_thresholds(
  p_brotherhood DECIMAL(10, 2),
  p_professional DECIMAL(10, 2),
  p_service DECIMAL(10, 2),
  p_scholarship DECIMAL(10, 2),
  p_health DECIMAL(10, 2),
  p_fundraising DECIMAL(10, 2),
  p_dei DECIMAL(10, 2)
)
RETURNS JSON
LANGUAGE plpgsql
...
BEGIN
  ...
  IF v_user_role != 'officer' OR v_user_position != 'vp_operations' THEN
    RAISE EXCEPTION 'Only VP Operations can update point thresholds';
  END IF;

  -- Update or insert thresholds
  INSERT INTO point_thresholds (
    id,
    brotherhood,
    professional,
    service,
...
GRANT EXECUTE ON FUNCTION update_point_thresholds(DECIMAL, DECIMAL, DECIMAL, DECIMAL, DECIMAL, DECIMAL, DECIMAL) TO authenticated;

COMMENT ON FUNCTION update_point_thresholds IS 'Updates point thresholds. Only VP Operations can execute this function.';

-- =====================================================
-- MIGRATION COMPLETE!
-- =====================================================
-- You can now use the dynamic point categories system
-- VP Operations can manage categories from the app
-- =====================================================
